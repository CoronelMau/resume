...
const mySkills = [
  ...
  { id: 16, name: "NodeJS", src: "../../img/nodejs.png", alt: "NodeJS image" },
  { id: 17, name: "Mongodb", src: "../../img/mongo.jpg", alt: "Mongodb image" },
  { id: 18, name: "Sql", src: "../../img/database.png", alt: "Sql image" },
